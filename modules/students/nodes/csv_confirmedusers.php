<?php
require_once($_SERVER['DOCUMENT_ROOT'] . '/interviews/engine/initialise.php');

$studentClass = new Students();
$invitees = $studentClass->find_all_confirmed();
...
header("Content-Disposition:attachment;filename=interviews_confirmed-invitees.csv");
